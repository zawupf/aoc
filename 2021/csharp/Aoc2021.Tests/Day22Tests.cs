...
public class Day22Tests
{
    ...
    {
        Assert.Equal(39L, Day22.Reactor.Init(input1));
        Assert.Equal(590784L, Day22.Reactor.Init(input2));
        Assert.Equal(474140L, Day22.Reactor.Init(input3));
    }
    ...
    {
        Day22 run = new();
        Assert.Equal("610196", run.Result1());
