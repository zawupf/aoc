...
public class Day04Tests
{
    ...
    {
        Assert.Equal(19, input.Count);
        Assert.Equal("7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1", input.First());
        Assert.Equal("2  0 12  3  7", input.Last());
    }
    ...
    {
        Day04 run = new();
        Assert.Equal("4662", run.Result1());
        Assert.Equal("12080", run.Result2());
    }
}
